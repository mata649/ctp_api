...
class UserUpdateRequest(ValidRequest):
...
def build_user_update_request(user: User, current_id: str) -> InvalidRequest | UserUpdateRequest:
    """Validates a UserUpdateRequest information.
    -----------------------------------------------------
    Validates that the full_name, email, password and rol attributes meet 
    the requirements of the request.
    ----------------------------------------------------- 
    Args:
        user (User): A User entity with full_name, rol and email attributes.
        current_id (str): id of the user making the request 
    ----------------------------------------------------- 
    Returns:
        InvalidRequest | UserUpdateRequest: Return an UserUpdateRequest with a payload
    ...
    return UserUpdateRequest(user, current_id)
